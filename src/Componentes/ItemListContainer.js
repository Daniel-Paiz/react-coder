...
const ItemListContainer = () => {
    ...
    return (
        <main>
            <h1 className="titulo__h1">CAMPANA SKATE SHOP</h1>
            <h2 className="h2__index"> Sean bienvenidos a nuetro sitio web , por el momento les ofrecemos un catalogo de los
            ...
            <div className="div__main">
                <img src={logo_skate_shop} alt="logo_skate_shop" className="imagen_ilustrativa" />
                <h3 className="caja__texto text-center">
                    ...
                    amamos </h3>
                <img src={logo_tabla_skate_shop} alt="logo2" className="imagen_ilustrativa" />
                <h2 className="titulo__h1">Tablas</h2>
                <ItemListProduct />
            </div>
        </main>
    )
